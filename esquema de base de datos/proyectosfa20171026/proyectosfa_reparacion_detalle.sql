...
CREATE TABLE `reparacion_detalle` (
  `idreparacion_detalle` int(11) NOT NULL,
  `idreparacion` int(11) NOT NULL AUTO_INCREMENT,
  `cantidad` double DEFAULT NULL,
  `costo` double DEFAULT NULL,
  PRIMARY KEY (`idreparacion_detalle`),
  KEY `fk_detalle_reparacion` (`idreparacion`),
  CONSTRAINT `fk_detalle_reparacion` FOREIGN KEY (`idreparacion`) REFERENCES `reparacion` (`idreparacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-10-26 18:41:52
