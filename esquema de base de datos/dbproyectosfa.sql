...
CREATE TABLE IF NOT EXISTS `proyectosfa`.`fac_detalle` (
  ...
  INDEX `fk_fcdetalle_factura_idx` (`idfac_detalle` ASC),
...
CREATE TABLE IF NOT EXISTS `proyectosfa`.`producto_almacen` (
  ...
  PRIMARY KEY (`id_almacen`, `id_inve`),
